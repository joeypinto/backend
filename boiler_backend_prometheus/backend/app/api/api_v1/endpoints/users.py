...
async def create_user(
    *,
    ...
    #locations_in: List[schemas.UserLocationRequest],
    #_: models.User = Depends(deps.get_current_active_superuser),
) -> Any:
    """
    Create new user.
    ...
    user_in.roles = roles
    responseUser = await repositories.user.create(db, obj_in=user_in)
...
async def create_user_open(
    *,
    ...
    user_in = schemas.UserCreateOpen(password=password, email=email, username=username)
